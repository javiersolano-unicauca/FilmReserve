...
public interface iMovieFunctionDao extends CrudRepository<MovieFunctionModel, MovieFunctionPK> {
    ...
    /**
     *  Metodo para saber si existe una funcion por campo 'cinemaRoom', 'active', y que se 
    ...
    MovieFunctionModel find(Integer prmCinemaRoom, Boolean prmActive, LocalDate prmDate);
    ...
    MovieFunctionModel findByIdMovieAndStartDateAndActive(Long prmIdMovie, LocalDate prmStartDate, Boolean prmActive);
}
